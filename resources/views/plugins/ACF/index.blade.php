...
@section('content')
    {{-- Top Actions handled by x-admin-table props and header_actions --}}

    <x-admin-table :pagination="$groups" :counts="$counts" :status="$status" :search="$search" route="admin.acf.index"
