...
@section('title', 'Add New Taxonomy')

@section('content')
    <div class="max-w-7xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Add New Taxonomy</h1>
        ...
        <form action="{{ route('admin.acf.taxonomies.store') }}" method="POST">
            @csrf
                    ...
                    <div class="p-6">
                        ...
                        <div x-show="tab === 'general'" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Plural Label <span
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Singular Label <span
                                            class="text-red-500">*</span></label>
                            ...
                            <div class="mt-6">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Taxonomy Key <span
                                        class="text-red-500">*</span></label>
                                <input type="text" name="key" value="{{ old('key') }}" required
                                    class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-gray-50 p-3"
                                    placeholder="e.g., genre" pattern="[a-z_]+"
                                    title="lowercase letters and underscores only">
                                <p class="text-xs text-gray-500 mt-1">Lowercase letters and underscores only. Max 20
                                    characters.</p>
                                @error('key')
                            ...
                            <div class="mt-6 pt-6 border-t">
                                ...
                                <p class="text-sm text-gray-600 mb-4">Select which post types this taxonomy should apply to.
                                </p>
                                <div class="grid grid-cols-2 gap-4">
                                    <label
                                        class="flex items-center space-x-3 cursor-pointer p-2 hover:bg-gray-50 rounded border border-transparent hover:border-gray-200">
                        ...
                        <div x-show="tab === 'settings'" class="space-y-6" x-cloak>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <label
                                        class="flex items-center space-x-3 cursor-pointer p-3 border rounded hover:bg-gray-50">
                                        <input type="radio" name="hierarchical" value="1" checked
                                            class="text-indigo-600 focus:ring-indigo-500 h-4 w-4">
                                        <div>
                                            <span class="block text-sm font-medium text-gray-900">Hierarchical (Like
                                                Categories)</span>
                                            <span class="block text-xs text-gray-500">Allows parent-child relationships.
                                                Checkbox inputs.</span>
                                        </div>
                                    </label>
                                    ...
                                    <label
                                        ...
                                        <input type="radio" name="hierarchical" value="0"
                                            class="text-indigo-600 focus:ring-indigo-500 h-4 w-4">
                                        <div>
                                            <span class="block text-sm font-medium text-gray-900">Non-Hierarchical (Like
                                                Tags)</span>
                            ...
                            <div class="pt-6 border-t">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <label
                                        class="flex items-center space-x-3 cursor-pointer p-3 border rounded hover:bg-gray-50">
                                        <input type="radio" name="publicly_queryable" value="1" checked
                                            class="text-indigo-600 focus:ring-indigo-500 h-4 w-4">
                                        <div>
                                            <span class="block text-sm font-medium text-gray-900">Public (Show View
                                                Link)</span>
                                            <span class="block text-xs text-gray-500">Accessible on frontend. Shows "View"
                                                link
                                                in admin.</span>
                                        </div>
                                    </label>
                                    ...
                                    <label
                                        ...
                                        <input type="radio" name="publicly_queryable" value="0"
                                            class="text-indigo-600 focus:ring-indigo-500 h-4 w-4">
                                        <div>
                                            <span class="block text-sm font-medium text-gray-900">Private (Admin
                                                Only)</span>
                                            <span class="block text-xs text-gray-500">Validation 404 on frontend. No "View"
                                                link.</span>
                                        </div>
                                    </label>
                                </div>
