                            ...
                            <div class="space-y-6">
                                ...
                                <div x-data="{ 
                                    ...
                                    <div class="relative">
                                        ...
                                        <div x-show="open" class="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm" x-cloak>
                                            ...
                                            <ul class="py-1">
                                                <template x-for="(label, key) in filteredLanguages" :key="key">
                                                    <li @click="selected = key; open = false; search = ''"
                                                        ...
                                                        <span x-show="selected === key" class="absolute inset-y-0 right-0 flex items-center pr-4" :class="selected === key ? 'text-white' : 'text-indigo-600'">
                                                ...
                                                <li x-show="Object.keys(filteredLanguages).length === 0" class="py-2 px-3 text-gray-500 italic">No results found</li>
                                            </ul>
                                        </div>
                                    </div>
