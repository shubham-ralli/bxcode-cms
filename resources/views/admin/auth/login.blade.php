...
<head>
    ...
    <title>Sign in - {{ \App\Models\Setting::get('site_title', 'BxCode CMS') }}</title>
...
<body class="h-full">
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <!-- Used generic logo or site title if no logo -->
            <div class="mx-auto h-12 w-12 bg-indigo-500 rounded-lg flex items-center justify-center text-white font-bold text-xl">
               {{ substr(\App\Models\Setting::get('site_title', 'B'), 0, 1) }}
            </div>
